...
st.title("Optimization demo : basic linear model")
...
st.write(
    "### Linear constraint : min_constraint < X * x_coef + Y * y_coef < max_constraint"
)
...
problem = LinearOptimizationProblem(
    x_min=x_min,
    x_max=x_max,
    y_min=y_min,
    y_max=y_max,
    ...
    x_coef_constraint=x_coef,
    y_coef_constraint=y_coef,
    x_coef_objective=a,
    y_coef_objective=b,
)
...
fig = plot3d.plot_optimization_problem(
